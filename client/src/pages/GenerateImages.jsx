  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex  items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <button className="w-full mt-6 flex items-center justify-center gap-2 px-4 py-2 text-sm bg-gradient-to-r from-[#00AD25] to-[#04FF50] text-white rounded-lg cursor-pointer">
          <Image className="w-5" />
          Generate Image
        </button>
      </form>
